    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex align-items-center gap-3 mb-4">
                ...
                <h1 class="h3 mb-0 text-dark fw-bold">تعديل: {{ $user->name }}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="card modern-card">
                <div class="card-header bg-gradient">
                    <h5 class="card-title text-white mb-0">
                        <i class="fas fa-edit me-2"></i>بيانات المستخدم
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('unit_number') is-invalid @enderror" id="unit_number" name="unit_number" value="{{ old('unit_number', $user->unit_number) }}" required>
                                    </div>
                                    @error('unit_number')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control @error('user_type') is-invalid @enderror" id="user_type" name="user_type" required>
                                        ...
                                        <option value="resident" {{ old('user_type', $user->user_type) === 'resident' ? 'selected' : '' }}>مقيم</option>
                                        <option value="owner" {{ old('user_type', $user->user_type) === 'owner' ? 'selected' : '' }}>مالك</option>
                                        <option value="tenant" {{ old('user_type', $user->user_type) === 'tenant' ? 'selected' : '' }}>مستأجر</option>
                                    </select>
                                    @error('user_type')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <small class="text-muted d-block mt-2">اتركها فارغة للاحتفاظ بكلمة المرور الحالية</small>
                                    @error('password')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
